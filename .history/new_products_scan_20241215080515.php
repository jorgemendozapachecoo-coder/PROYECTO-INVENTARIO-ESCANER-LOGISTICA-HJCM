                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td><?php echo htmlspecialchars($row['CODIGO_FAMILIA_ACTUAL'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['DENOMINACION_BIEN'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['CODIGO_FAMILIA_CORRECTO'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['DENOMINACION'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['TIPO'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['MARCA'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['MODELO'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['SERIE'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($fechaAdquisicion ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['CODIGO_PATRIMONIAL'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($row['FECHA_ACTUAL'] ?? ''); ?></td>
                            <td class="<?php echo $antiguedadClass; ?>"><?php echo htmlspecialchars($antiguedad); ?></td>
                            <td>
                                <a href="edit_new_product.php?id=<?php echo htmlspecialchars($row['ID'] ?? ''); ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="new_products_scan.php?delete_id=<?php echo htmlspecialchars($row['ID'] ?? ''); ?>" 
                                   class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">Eliminar</a>
                            </td>
                        </tr>
