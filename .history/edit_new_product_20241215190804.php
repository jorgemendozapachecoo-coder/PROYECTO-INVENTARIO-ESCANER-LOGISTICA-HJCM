...
<body>
    ...
    <input type="text" id="nombre_area" name="nombre_area" class="form-control" 
           value="<?php echo htmlspecialchars($producto['NOMBRE_AREA'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
</div>
<div class="col-md-6 mb-3">
    ...
    <input type="text" id="codigo_familia_actual" name="codigo_familia_actual" class="form-control" 
           value="<?php echo htmlspecialchars($producto['CODIGO_FAMILIA_ACTUAL'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
</div>
<div class="col-md-6 mb-3">
    ...
    <input type="text" id="denominacion_bien" name="denominacion_bien" class="form-control" 
           value="<?php echo htmlspecialchars($producto['DENOMINACION_BIEN'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
</div>
<div class="col-md-6 mb-3">
...
<div class="col-md-6 mb-3">
    ...
    <input type="text" id="tipo" name="tipo" class="form-control" 
           value="<?php echo htmlspecialchars($producto['TIPO'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
</div>
<div class="col-md-6 mb-3">
